...
import ws.b.finalexam.exceptions.NonexistentEntityException;
import ws.b.finalexam.exceptions.PreexistingEntityException;
...
public class PersonJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ws.b_finalexam_jar_0.0.1-SNAPSHOTPU");
